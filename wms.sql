/*
 ...
 Source Schema         : wms2016

 Target Server Type    : MySQL
 Target Server Version : 50648
 File Encoding         : 65001

 Date: 26/04/2026 14:37:28
*/
...
CREATE TABLE `wms_access`  (
  ...
  `pid` smallint(6) NULL DEFAULT NULL COMMENT '父id',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限分配' ROW_FORMAT = Compact;
...
CREATE TABLE `wms_ad`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主id',
  `name` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '广告位名称',
  `mark` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '广告位标识',
  ...
  `normal_content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '正常显示内容',
  `overdue_content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '过期显示内容',
  `status` tinyint(1) NULL DEFAULT 1 COMMENT '1为可用 2为禁用',
  ...
  INDEX `idx_mark`(`mark`) USING BTREE,
...
INSERT INTO `wms_admin` VALUES (33, 'admin', 'admin', 'c506ff134babdd6e68ab3e6350e95305', '11', '111@qq.com', 1461204870);
...
CREATE TABLE `wms_attribute`  (
  ...
  `type` enum('range','number','radio','file','checkbox','button','week','time','date','password','text','email','url','month','tel','search','select','color') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'text',
...
CREATE TABLE `wms_brand`  (
  ...
  `time` int(11) UNSIGNED NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '品牌表' ROW_FORMAT = Compact;
...
CREATE TABLE `wms_config`  (
  ...
  `field_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '字段名称',
  `field_value` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '字段内容',
  `field_desc` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '字段描述',
  `type` tinyint(1) NOT NULL DEFAULT 1 COMMENT '类型',
  `atta_type` tinyint(1) NOT NULL DEFAULT 2 COMMENT '1=有附件2=无',
  `create_time` int(11) NOT NULL DEFAULT 0 COMMENT '创建时间',
  `update_time` int(11) NOT NULL DEFAULT 0 COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_filed_name`(`field_name`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '网站配置' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '仓库' ROW_FORMAT = Compact;
...
CREATE TABLE `wms_goods`  (
  ...
  `sn` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'sn',
  ...
  `time` int(11) UNSIGNED NULL DEFAULT NULL COMMENT '时间',
  `price` decimal(10, 2) NULL DEFAULT NULL,
  `sum` mediumint(12) UNSIGNED NULL DEFAULT NULL,
...
CREATE TABLE `wms_goods_attrbute`  (
  `goods_id` mediumint(9) UNSIGNED NULL DEFAULT NULL,
  `attrbute_id` mediumint(9) UNSIGNED NULL DEFAULT NULL,
  `attrbute_value` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `price` decimal(10, 2) UNSIGNED NULL DEFAULT NULL,
  `count` mediumint(12) UNSIGNED NULL DEFAULT NULL,
  `val` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wms_goods_extend`  (
  `goods_id` mediumint(9) UNSIGNED NULL DEFAULT NULL,
  `val` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `price` decimal(10, 2) NULL DEFAULT NULL,
  `count` mediumint(12) UNSIGNED NULL DEFAULT NULL,
...
CREATE TABLE `wms_link`  (
  ...
  `icon` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '图片',
...
CREATE TABLE `wms_news`  (
  ...
  INDEX `idx_create_time`(`create_time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '最新公告' ROW_FORMAT = Compact;
...
CREATE TABLE `wms_news_category`  (
  ...
  `update_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '资讯类别' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 72 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限节点' ROW_FORMAT = Compact;
...
CREATE TABLE `wms_oplog`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主id',
  `model` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '模块',
  `action` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '动作',
  `admin_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '用户id',
  `admin_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '用户名',
  `role_id` int(10) NOT NULL DEFAULT 0 COMMENT '管理角色id',
  `role_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '管理角色',
  `bak` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '备注',
  `create_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台操作表' ROW_FORMAT = Compact;
...
CREATE TABLE `wms_position`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '职位名称',
  `time` int(11) UNSIGNED NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '职位表' ROW_FORMAT = Compact;
...
CREATE TABLE `wms_privilege`  (
  `id` mediumint(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `name` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '权限名称',
  `parent_id` mediumint(11) UNSIGNED NULL DEFAULT 0 COMMENT '父级id',
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限表' ROW_FORMAT = Compact;
...
CREATE TABLE `wms_record`  (
  `goods_id` mediumint(9) UNSIGNED NOT NULL,
  `no` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '员工编号',
  `name` varchar(18) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '员工姓名',
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '销售记录' ROW_FORMAT = Compact;
...
CREATE TABLE `wms_role_privilege`  (
  ...
  `role_id` mediumint(12) UNSIGNED NOT NULL COMMENT '角色id',
  INDEX `role_id`(`role_id`) USING BTREE,
  INDEX `privliege_id`(`privliege_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色权限表，角色->权限' ROW_FORMAT = Compact;
...
CREATE TABLE `wms_role_user`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主id',
  `role_id` mediumint(9) UNSIGNED NULL DEFAULT NULL COMMENT '角色id',
  `user_id` char(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户id',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_role_id`(`role_id`) USING BTREE,
  INDEX `idx_user_id`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户角色' ROW_FORMAT = Compact;
...
CREATE TABLE `wms_sale`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '销售' ROW_FORMAT = Compact;
...
CREATE TABLE `wms_stock`  (
  ...
  `sn` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '产品sn号',
  `depot_id` mediumint(12) UNSIGNED NOT NULL COMMENT '仓库id',
...
CREATE TABLE `wms_store`  (
  `id` mediumint(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `leader` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '负责人，领导人',
  `name` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '门店名称',
...
CREATE TABLE `wms_userinfo`  (
  ...
  `no` varchar(25) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `qq` int(11) UNSIGNED NULL DEFAULT NULL COMMENT 'qq',
  ...
  `sex` enum('女','男') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
