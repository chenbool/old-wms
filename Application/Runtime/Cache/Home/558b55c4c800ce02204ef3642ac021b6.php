...
<?php echo jumps($infos['authority'],CONTROLLER_NAME);?>
        ...
        <div id="main">            
            ...
            <form action="/wms/index.php/Role/add.html" method="post" class="main_form">
                ...
                <div class="input_info_high">
                    <div class="input_info_scroll">
                        <ul>
<!--遍历权限-->
<?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><input type="checkbox" value='<?php echo ($vo["id"]); ?>' name='privliege_id[]'/><?php echo ($vo["name"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>                                                        
                        </ul>
                    </div>
                    <span class="required">
...
<script type="text/javascript">
    function send(){
                ...
                $.ajax({
                    url: '/wms/index.php/Role/add.html',
                    type: 'post',
                    dataType:'json',
